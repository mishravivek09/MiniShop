...
function trendingWomen() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=WOMEN";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingMen() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=MEN";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingKids() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=KIDS";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingSport() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=SPORT";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingBooks() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=STATIONARY";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingMobiles() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=MOBILE";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingLaptops() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=LAPTOP";
  fetch(url)
    .then((res) => {
      return res.json();
    })
...
function trendingCosmetics() {
  let url =
    "https://mini-shop-lmvw.onrender.com:443/product/category?cat=COSMETICS";
  fetch(url)
    .then((res) => {
      return res.json();
    })
